...
const Banner = () => {
    return (
        <div className="xl:h-[600px] lg:h-[400px] md:h-[420px] h-[320px] bg-amber-100 flex flex-col justify-center items-center">
            <h1 className="flex justify-center items-center lg:gap-4 md:gap-3 gap-2 text-black xl:text-5xl lg:text-4xl md:text-3xl text-2xl font-bold text-center lg:w-1/2 md:w-2/3">Welcome to <span className='text-amber-700'>Leaderboard</span><MdOutlineLeaderboard /></h1>
