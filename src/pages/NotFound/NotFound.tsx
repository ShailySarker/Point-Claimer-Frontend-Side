...
const NotFound = () => {
    return (
        <div className="flex flex-col justify-center items-center h-screen">
            ...
            <Link to='/'>
                <button className="lg:text-lg md:text-base text-sm font-semibold text-white bg-amber-700 hover:bg-amber-600 hover:rounded-4xl xl:px-8 px-6 xl:py-[10px] md:py-2 py-[7px] rounded-xl lg:mt-8 mt-6 shadow-md">Go Back</button>
            </Link>
        </div>
    );
};
