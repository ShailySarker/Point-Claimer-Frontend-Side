...
const Newsletter = () => {
    ...
    return (
        <div className="lg:px-20 md:px-12 px-6 lg:mt-20 md:mt-16 mt-14 bg-amber-100 lg:py-12 md:py-8 py-6 xl:mb-24 lg:mb-20 md:mb-16 mb-14">
            <div>
                <h1 className="xl:text-4xl/normal md:text-3xl/normal text-2xl/normal font-bold text-center text-black">Get Newsletter</h1>
                <p className="text-center lg:w-[60%] md:w-[75%] w-[90%] mx-auto xl:text-xl lg:text-lg md:text-lg text-sm lg:mt-2 md:mt-[6px] mt-2 text-black">Stay ahead of the latest features and exclusive offers with our Point Claimer Newsletter!</p>
            </div>
